...
public class LinkBudgetServiceTest {
    ...
    void marginShouldDecreaseWhenDistanceIncreases() {
        ...
        LinkBudgetResult r1 = service.evaluate("dev-1", "gw-1", 100, 868, 14, -130, true, 20, 30, 1.5, 0, 50, 0, 0, 0, 0);
        LinkBudgetResult r2 = service.evaluate("dev-1", "gw-1", 500, 868, 14, -130, true, 20, 30, 1.5, 0, 50, 0, 0, 0, 0);
